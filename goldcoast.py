...
def get_goldcoast():
    ...
    with open("./img/goldcoast/response_gc.txt", 'w') as f:
        for i in goldcoast:
            f.write('{}\n'.format(i))
...
def make_temp_plot():
    ...
    plot = open("./img/goldcoast/response_gc.txt", 'r')
    ...
    plt.savefig('./img/goldcoast/temp.png')
...
def make_wind_plot():
    ...
    plt.savefig('./img/goldcoast/wind.png')
...
def make_humid_plot():
    ...
    plt.xlabel('Date and Time')
    plt.ylabel('Humidity (%)')
    plt.savefig('./img/goldcoast/humidity.png')
